    ...
    <div class="container mx-auto p-5">
        <div class="house-detail__top grid grid-cols-3 p-5 mb-5 border rounded-xl">
            ...
            <div class="house-detail__top-item">
                ...
                <!-- <div class="flex items-center mb-5">
                    <span class="text-gray-400 w-16">单间</span>
                    <div class="house-detail__rooms w-full grid grid-cols-3">
                        <div
                            class="house-detail__room flex flex-col justify-center text-center"
                        ...
                        >
                            ...
                            <span class="text-3xl">{{ item.size }}</span>
                            <span class="text-md text-gray-400">使用面积</span>
                            <span class="text-3xl">{{ item.price }}元</span>
                            <span class="text-md text-gray-400">月租</span>
                            <span v-if="item.tenement !== null">已租</span>
                        </div>
                    </div>
                </div>-->
                <div class="flex items-center mb-5">
...
const onJoinRentClick = () => {
    ...
    RequestUtil.getJoinRentHouse(houseId, selectedRoomId)
        ...
        .catch(err => {
            // console.log(err)
            NotificationUtil.Notify('出错了，请联系工作人员。', { title: '错误', type: msgType.ERROR })
        })
}
