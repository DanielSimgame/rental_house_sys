<template>
  <el-affix offset-top="0">
    <div class="bg-white shadow grid grid-cols-12">
      <div class="logo-container my-auto px-5 group 2xl:col-span-1 xl:col-span-1 lg:col-span-2 md:col-span-2 sm:col-span-2">
        <router-link to="/" class="relative">
          ...
          <div class="logo-tip w-fit lg:w-16 pl-2 pr-3 z-20 -translate-y-6 rounded-lg group-hover:border group-hover:border-slate-200 group-hover:translate-x-16 opacity-0 group-hover:opacity-100 group-hover:shadow-lg transition-all ease-in-out font-bold text-md">首页</div>
        </router-link>
      </div>
      ...
      >
        ...
        <div class="w-full flex flex-row justify-around items-center" v-else>
          <span>用户</span>
          <el-button type="primary 2xl:w-fit">成为业主</el-button>
        </div>
        <div class="flex flex-col justify-center items-center">
